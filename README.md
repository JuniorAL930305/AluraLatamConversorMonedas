...
Desarrollado en Java con una interfaz gráfica de usuario (GUI) utilizando la biblioteca Swing, la aplicación permite a los usuarios convertir diferentes divisas utilizando una API de tasas de cambio en tiempo real
